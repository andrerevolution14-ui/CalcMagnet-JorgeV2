    ...
    return (
        <div className="min-h-[100dvh] flex items-center justify-center p-6 bg-white">
            <motion.div
                ...
                className="premium-card max-w-xl w-full space-y-8 md:space-y-12"
            >
                <div className="flex flex-col items-center text-center space-y-6">
                    <div className="p-4 bg-[#D4AF37]/10 text-[#D4AF37] rounded-full">
                        <ShieldCheck size={40} />
                    </div>
                    <h2 className="text-3xl md:text-5xl font-black text-[#111111] leading-tight">A clareza que a tua casa merece</h2>
                ...
                <button
                    onClick={onContinue}
                    className="w-full btn-premium-gold shimmer-premium !py-6"
                >
                    <span>Quero ver a minha estimativa</span>
                    <ArrowRight size={24} />
                </button>
            </motion.div>
        </div>
